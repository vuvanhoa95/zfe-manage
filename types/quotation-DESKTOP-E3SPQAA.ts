...
export type QuotationFormData = {
    ...
    templateId?: 'standard' | 'minimalist' | 'detailed'; // Layout template choice
    sectionOrder?: string[]; // Custom order of document sections
    media?: Array<{
        id: string;
...
export type OutsourceLineInput = {
    ...
    unit?: string;
    qty?: number;
    quantity?: number; // Aliased for UI consistency
    unitRate?: number;
    amount?: number;
    note?: string;
    order: number;
