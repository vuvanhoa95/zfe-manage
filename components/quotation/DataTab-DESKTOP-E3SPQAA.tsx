...
import AIIntroGenerator from './AIIntroGenerator';
                        ...
                        <div className="space-y-4">
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <label className="block text-sm font-medium">Lời mở đầu</label>
                                    {data.customerId && data.projectName && (
                                        <AIIntroGenerator
                                            customerId={data.customerId}
                                            projectName={data.projectName}
                                            projectNotes={data.projectNotes}
                                            totalArea={data.totalArea}
                                            onApply={(introText) => updateField('introText', introText)}
                                            currentIntro={data.introText}
                                        />
                                    )}
                                </div>
                                <textarea
                                    ...
                                    className="w-full px-3 py-2 border rounded min-h-[120px] text-sm"
